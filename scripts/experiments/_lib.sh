# Shared orchestrator helpers for swordstamp.sh.
#
# Source this after the runner's defaults; it fills in the operational knobs
# and brings in the GPU policy. Reads DRY_RUN, PRIORITY,
...
# The SwordStamp runner defines a cell as one additive ladder rung.
