...
class PaperRegistryTests(unittest.TestCase):
    ...
    def test_orchestrator_dry_runs_are_paper_only(self):
        expected_footer = {
            "swordstamp.sh": "paper cells: 11 (10 rungs + baseline)",
            "pmark.sh": "paper cell: online PMark, N=64",
            "samark.sh": "paper cell: flags-run SAMark, msig=2, N=64",
        }
        with tempfile.TemporaryDirectory() as cache:
            ...
            for script, footer in expected_footer.items():
